...
/*Read all the fields from the database*/
...
//this is were im gonna edit the fields
...
<b>Phone Number: </b><?php echo $results['phone']?><br>
    ...
    function corpDelete($db,$id){
        ...
        ?>
        <h1><?php echo $results['corp'] ?> was deleted!</h1>
    ...
    function corpAdd2($db){
        ...
        <div >
        <form method="post" action="index.php">
			<!--tHIS IS WHERE IM GOING TO ADD A NEW CORP -->
